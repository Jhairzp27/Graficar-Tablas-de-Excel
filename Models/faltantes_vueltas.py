...
def generar_grafico_faltantes_vueltas_semanal(filepath, tipo_unidad, num_unidad, ax=None):
    ...
    if tipo_unidad == "Grandes":
        ...
        title = f'Faltantes L-V - Unidad {num_unidad}'
    elif tipo_unidad == "Micros":
        rango_filas = (29, 63)
        columna_faltante_anual = 3  # Columna D
        columna_faltante_real_anual = 4   # Columna E
        title = f'Faltantes L-V - Unidad {num_unidad} [Km]'
